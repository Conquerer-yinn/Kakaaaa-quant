...
import { STUDY_BADGE, buildStrategyMetrics, formatPercent } from "../src/pages/strategyViewModel.js";
...
test("strategy badge identifies the V2 research contract", () => {
  assert.deepEqual(STUDY_BADGE, { status: "v2", label: "V2 研究" });
});
